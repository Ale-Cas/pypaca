...
class NonEmptyRequest(BaseModel):
    ...
    def to_request_fields(self) -> dict:
        """
        Equivalent of self::dict but removes empty values and handles converting non json serializable types.
        ...
        def map_values(val: Any) -> Any:
            """Convert types here to be encodable."""
