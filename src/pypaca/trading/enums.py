"""Enums used throughout the trading module."""
...
class ActivityType(str, Enum):
    ...
    def is_trade_activity(self) -> bool:
        """
        Check to see if the ActivityType represents a type that belongs to TradeActivity.
    ...
    def is_str_trade_activity(value: str) -> bool:
        """
        Check similar to is_trade_activity but for raw data that hasn't been parsed into an enum yet.
